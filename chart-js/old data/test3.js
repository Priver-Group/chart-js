    ...
    function graphic() {
      fetch('short_average_crop_indices_farm-0000000014_04-A-1-4-121-907.json')
        ...
        .then((jsonData) => {
          ...
          const interpolatedNDVI = interpolateData(jsonDates, jsonNDVI, new Date('2024-02-10'));
          const interpolatedAfectedArea = interpolateData(jsonDates, jsonAfectedArea, new Date('2024-02-10'));
          ...
          const datasets = [
            ...
            {
              label: 'Area Afectada',
              data: jsonAfectedArea.map((value, index) => ({
                x: labels[index],
                y: value,
              })),
              borderColor: '#2D1515',
