//const interpolatedNDVI = interpolateData(jsonDates, jsonNDVI, formattedDates);
//const interpolatedAfectedArea = interpolateData(jsonDates, jsonAfectedArea, formattedDates);
    ...
    fetch('short_average_crop_indices_farm-0000000014_04-A-1-4-121-907.json')
      ...
      .then((jsonData) => {
        ...
        const datasets = [
          ...
          {
            label: 'Vigor',
            data: labels.map(() => interpolatedNDVI),
            borderColor: '#FFC107',
